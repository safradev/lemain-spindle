...
from core.domain.entities import DownloadRequest, DownloadResult, MediaFormat, ProgressEvent
from core.domain.ports import PathValidator, UrlValidator, VideoGateway
